...
const newUser = async ({ username, email, password, phonenumber}) => {
                            ...
                            <p className="pv2 fw6 tc"><small className="orange f4">Welcome</small><br/> It only takes a <small className="green f4">few seconds</small> to create your account</p>
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="tl pv2">
                                        ...
                                        <input type="password" name="password" value={password} className="password br3 ba pa3 w-100" placeholder="password..." required autoComplete="current-password" />
                                    </div>
                                    <div className="tl pv2">
