...
const Navbar = () => {
    ...
    return(
        <nav className="fw5 navbar tc" style={{position: 'fixed', width: '100%', backgroundColor: '#ffffff', borderBottom: '1px thin black'}}>
            <Typography>
                <div className="">
                    <span style={{fontSize: '35px'}} className="ph2">
                        <Link to={"../assets/AdbillBoard"} title="adbillboard" className="navbar ph4 br3 black link hover-bg-light-gray f3 fw6 icon-home pv2"></Link>
                        ...
                        <Link title="profile" to={"/assets/vendor/Profile"} className="navbar pv2 f3 hover-bg-light-gray br3 icon-user link fw6 black ph4"></Link>
                    </span>
                </div>
            </Typography>
        </nav>
