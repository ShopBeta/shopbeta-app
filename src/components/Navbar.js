...
const Navbar = () => {
    ...
    return(
        <nav className="bg-white tc pv2 shadow-2" style={{position: 'fixed', width: '100%', borderBottom: '1px thin black'}}>
            <Typography>
                <div className="">
                    <span style={{color: '#ee9617', fontSize: '27px', fontWeight: '515', letterSpacing: '-3px'}} className="pa1 code">ShopBeta</span>
                    <span style={{fontSize: '29px'}} className="ph2">
                        ...
                        <Link to={""} title="feed" className="ph3 fw5 link black" ></Link>
                        ...
                        <Link to={"../assets/VideoSpace"} title="video sapce" className="navbar ph4 br3 black hover-bg-light-gray f3 fw5 icon-social-youtube pv2"></Link>
