    ...
    return (
        <div style={{ overflowY: 'scroll', height: '540px'}} className="dib tl w-90">
            ...
            <p className="f5 fw6 orange code">Account Profile</p>
              <div className="tc bg b--black br3 pa3">
            <div className="cover br4">
                ...
                <h5 className="f3 code white fw5 tc">{data.username}</h5>
                <p className="tc pa2 white code f6 fw6">Space industry .<small className="icon-globe ph2"></small></p>
            </div>
            </div>
            <span className="tc">
            <div className="pv2 code tc fw6">
                <p className="f3 fw5 orange code">85,904 <small className="icon-user"></small></p>
                <p className="pv2">LOCATION:<small className="ph2">No 17 Isa Kaita Road Malalali, Kaduna, Nigeria</small></p>
                <p className="pv3">
                    <p><small className="ph2">mobile: +234</small>0808077489</p>
                    <p><small className="ph2">email:</small>ronelmike590@gmail.com</p>
                    <p><small className="ph2">website:</small><a href="/webpage" className="link">www.ronelbeautyshop.com</a></p>
                </p>
            </div>
            <span className="b">
                <button onClick={handleShow} className="bg-orange white ba hover-bg-mid-gray pointer pa2 tc br-pill ph5 ma1 grow b fw6">Message</button>
                                </span>
            <span className="b">
                <button onClick={buttonClick} className="bg-orange white pointer ba hover-bg-mid-gray pa2 tc br-pill ph5 ma1 grow b fw6">Follow</button>
            </span>
            <span className="b">
